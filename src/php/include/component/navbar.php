    ...
    <div class="contain-features">
        ...
        <div class="features c-users config-users"><a class="nav-redirection" href="./configs.php?nav=c-users" title="Configurer les utilisateurs"><i class="nav-fa-icons fa-solid fa-user-gear"></i><span class="nav-span">Configurer Utilisateurs</span></a></div>
        <div class="features c-article config-article"><a class="nav-redirection" href="./configs.php?nav=c-article" title="Configurer les articles"><i class="nav-fa-icons fa-solid fa-user-gear"></i><span class="nav-span">Configurer Articles</span></a></div>
        <div class="features c-famille config-famille"><a class="nav-redirection" href="./configs.php?nav=c-famille" title="Configurer les familles"><i class="nav-fa-icons fa-solid fa-user-gear"></i><span class="nav-span">Configurer Familles</span></a></div>
        <div class="features c-ccout config-ccout"><a class="nav-redirection" href="./configs.php?nav=c-ccout" title="Configurer les centres de coûts"><i class="nav-fa-icons fa-solid fa-user-gear"></i><span class="nav-span">Configurer C. Coût</span></a></div>
    </div>
